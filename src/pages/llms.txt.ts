...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    "",
    "## Démos interactives (artefacts testables dans le navigateur)",
    "",
    `- [Support de formation IA & Texte](${SITE.url}/demos/deck-formation/) : deck réel d'une mission, anonymisé (38 écrans navigables)`,
    `- [Support scrollytelling groupe retail](${SITE.url}/demos/support-groupe-retail.html) : support réel anonymisé, charte de l'organisme partenaire`,
    `- [Restitution d'audit agence créative](${SITE.url}/demos/restitution-agence-creative.html) : le deck réellement présenté à la direction, anonymisé`,
    `- [Feuille de route post-formation](${SITE.url}/demos/feuille-de-route-enseigne.html) : livrable réel anonymisé, cartographie d'assistants par pôle`,
    `- [Guide d'autonomie Claude × ClickUp](${SITE.url}/demos/guide-claude-clickup.html) : guide réel en 6 niveaux, anonymisé`,
