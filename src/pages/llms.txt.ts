...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    "- Le premier mois installe : positionnement et structure d'offre, identité refaite avec charte",
    "  et gabarits, plan marketing sur douze mois, 2 à 3 assistants IA installés dans les outils de",
    "  l'entreprise, équipes formées. Le client en conserve l'intégralité, y compris s'il s'arrête là.",
    "- Ensuite :",
