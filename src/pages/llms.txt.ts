...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    "> Vingt ans de marketing (Publicis, production audiovisuelle et agence) ; formateur en IA ;",
    "> une cinquantaine d'organisations accompagnées, de Dassault Systèmes à SNCF Fret.",
    "",
