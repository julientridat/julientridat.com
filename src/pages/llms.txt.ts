...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    "",
    "- Mois 1 — Installation : 4 000 € HT. Positionnement et structure d'offre, identité refaite",
    "  avec charte et gabarits, plan marketing sur douze mois, 2 à 3 assistants IA installés dans",
    "  les outils de l'entreprise, équipes formées.",
