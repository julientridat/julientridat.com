...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    "",
    "> Je rejoins l'équipe du dirigeant plutôt que sa liste de prestataires : un mois de starter pack,",
    "> puis votre plan mis en œuvre chaque semaine, un livrable à date.",
    ...
    "",
    "- Abonnement mensuel : 2 500 € HT par mois dès le premier mois, sans engagement, résiliable à tout moment.",
    "- Mois 1, le starter pack : semaine 1, état des lieux ; semaine 2, plan marketing sur douze mois",
    ...
    "- Ensuite : le plan d'action mis en œuvre chaque semaine, un livrable à date, point hebdomadaire de 45 minutes,",
