...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    "> Vingt ans de marketing. Depuis 2018, accompagnement de dirigeants de PME dans le",
    "> développement de leur entreprise ; une cinquantaine d'organisations, de Dassault Systèmes",
    "> à SNCF Fret. Formateur en IA. Marketing ET technique : Brevo, ClickUp, Microsoft 365,",
    "> Google Workspace, sites et applications — un seul interlocuteur au lieu de trois prestataires.",
    "",
