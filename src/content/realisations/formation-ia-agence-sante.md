...
transformation: "L'équipe génère désormais un premier jet déjà sourcé sur ses propres autorités de santé, planifie ses projets au standard maison, et concentre le temps humain sur la validation médicale — le tout encodé dans des assistants qui tournent encore."
pitch: "Trois assistants installés dans une agence santé : contenu sourcé, brief créa et rétroplanning — premier jet automatisé, validation médicale préservée, équipe autonome."
resultats:
  - chiffre: "14"
    label: "personnes de l'équipe texte montées en autonomie"
  - chiffre: "1h30"
    label: "récupérée par jour et par utilisateur régulier"
  - chiffre: "3"
...
methode:
  ...
  - etape: "Cartographie"
    detail: "Cas d'usage tirés du métier, pas d'un catalogue : fiche pathologie, fiabilisation des sources, comptes-rendus, bibliographie dynamique."
...
assistants:
  - nom: "Fiche pathologie"
    ...
    sortie: "Premier jet en 9 sections, sourcé"
    fait: "Rien sans source : recherche restreinte aux autorités officielles FR/UE, tout fait non sourcé marqué à sourcer plutôt qu'inventé."
  - nom: "Brief créa"
    entree: "Fiche scientifique validée"
    sortie: "Brief studio + pistes visuelles"
    fait: "Traduit le socle validé pour la création avec un à faire / à ne pas faire réglementaire par cible, sans produire de donnée médicale nouvelle."
  - nom: "Rétroplanning"
    entree: "Brief projet"
    sortie: "Fichier .xlsx au format maison"
    fait: "Encode le standard maison — hiérarchie livrable / phase / tâche, code couleur, circuit de validation réglementaire intégré par construction."
visuel:
